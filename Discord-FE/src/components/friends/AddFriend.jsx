      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className={`flex-1 p-2 rounded ${
            isDarkMode ? "bg-[#2b2d31] text-gray-300" : "bg-gray-100 text-[#333333] border border-gray-300"
          }`}
        />
        <button
          onClick={handleSearch}
          className={`px-4 py-1 rounded ${
            isDarkMode ? "bg-[#5865f2] text-white hover:bg-[#4752c4]" : "bg-[#1877F2] text-white hover:bg-[#0D6EFD]"
          } inline-block`}
        >
          {t("Find Friend")}
        </button>
