...
export default function AdminPanel() {
  ...
  const viRoleData = [
    { name: "Role tùy chỉnh", Roles: 45 },
    { name: "Role cao nhất", Roles: 10 },
    { name: "Role thấp nhất", Roles: 1 },
  ];
        ...
        <main className="flex-1 overflow-y-auto w-full">
          <div className="grid grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 lg:p-8">
            ...
            <Card className="p-6 lg:p-8">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={language == "en" ? newMembersData : viNewMembersData}>
            ...
            <Card className="p-6 lg:p-8">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart layout="vertical" data={language == "en" ? roleData : viRoleData}>
                    <CartesianGrid stroke="hsl(var(--border))" strokeDasharray="3 3" />
